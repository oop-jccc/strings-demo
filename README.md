...
[![.NET CI/CD Pipeline](https://github.com/oop-jccc/strings-demo/actions/workflows/ci.yml/badge.svg)](https://github.com/oop-jccc/strings-demo/actions/workflows/ci.yml)
...
3. **Restore Dependencies:**
   ```bash
   dotnet restore StringTests\StringTests\StringTests.csproj
   ```
...
```
StringTests/
â”œâ”€â”€ StringTests.csproj    # Project configuration
